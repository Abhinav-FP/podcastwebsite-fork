          ...
          <div className="relative w-full max-w-[1440px] mx-auto flex flex-col md:flex-row rounded-[12px] overflow-hidden bg-gradient-custom shadow-xl p-4 sm:p-6 md:p-8 gap-6">
            ...
            <div className="w-full md:w-1/2">
              <Image
                ...
                className="w-full h-auto object-cover rounded-[12px] aspect-video md:aspect-auto"
              />
            </div>

            {/* Content */}
            <div className="w-full md:w-1/2 p-4 sm:p-6 md:p-[45px] flex flex-col justify-center">
              ...
              <h2 className="font-outfit font-medium text-2xl sm:text-3xl md:text-4xl lg:text-[42px] leading-snug tracking-[-0.03em] text-white mb-4">
                Free Property Investing Guides
              </h2>

              <p className="text-sm sm:text-base md:text-lg lg:text-[20px] mb-4 md:mb-8 text-[#FFFFFFB2] font-outfit font-[400]">
