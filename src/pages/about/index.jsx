            ...
            <div className="bg-gray-900 min-h-screen text-white font-sans antialiased">
                ...
                <header className="py-16 px-4 text-center">
                    ...
                    <p className="text-lg text-gray-400 max-w-3xl mx-auto">
                        Have a question, guest suggestion, or just want to say hello? We'd love to hear from you.
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        ...
                        <div className="bg-gray-800 p-8 rounded-lg shadow-lg">
                            ...
                            <form>
                                ...
                                <button
                                    type="submit"
                                    className="w-full flex items-center justify-center bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white font-semibold py-3 px-6 rounded-lg transition duration-300 ease-in-out"
                                >
                                    <svg
                                        ...
                                        fill="currentColor"
                                    >
                                        <path d="M10.894 2.553a1 1 0 00-1.788 0l-7 14a1 1 0 001.169 1.409l.684-.275a1 1 0 00.579-.938V10.5a1 1 0 011-1h4a1 1 0 011 1v4.932l.684.275a1 1 0 001.169-1.409l-7-14z" />
                                    </svg>
                                    Send Message
                                </button>
                            </form>
                        ...
                        <div className="bg-gray-800 p-8 rounded-lg shadow-lg">
                            ...
                            <div className="bg-gray-700 rounded-md overflow-hidden h-64 flex items-center justify-center">
                                <img
                                    src="https://via.placeholder.com/600x300?text=Map+Placeholder" // Replace with a static map image or embedded map
                                    alt="Our location on a map of North America"
                                    className="w-full h-full object-cover"
                                />
                            </div>
                            {/* You could also use an iframe for Google Maps embed here */}
                            {/*
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1dXYZ!2dXYZ!3dXYZ!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMTPCsDQzJzA3LjMiTiAxMDDCsDEyJzIyLjQiVw!5e0!3m2!1sen!2sus!4v1625000000000!5m2!1sen!2sus"
              width="100%"
              height="250"
              style={{ border: 0 }}
              allowFullScreen=""
                            ...
                            <ul className="space-y-4">
                                <li className="flex items-center">
                                    ...
                                    <div>
                                        ...
                                        <a href="mailto:email@propertypodcast.com.au" className="text-white hover:text-purple-400 transition-colors">
                ...
                <section className="py-16 px-4">
                    ...
                    <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div className="bg-gray-800 p-6 rounded-lg shadow-lg">
                            <h3 className="text-xl font-semibold mb-2">Can I be a guest on the podcast?</h3>
                        ...
                        {/* FAQ Item 2 */}
                        <div className="bg-gray-800 p-6 rounded-lg shadow-lg">
                            <h3 className="text-xl font-semibold mb-2">Do you offer personal consultations?</h3>
                            <p className="text-gray-300">
                        ...
                        {/* FAQ Item 3 */}
                        <div className="bg-gray-800 p-6 rounded-lg shadow-lg">
                            <h3 className="text-xl font-semibold mb-2">How can I suggest episode topics?</h3>
                            <p className="text-gray-300">
                        ...
                        {/* FAQ Item 4 */}
                        <div className="bg-gray-800 p-6 rounded-lg shadow-lg">
                            <h3 className="text-xl font-semibold mb-2">Are your guides really free?</h3>
                            <p className="text-gray-300">
